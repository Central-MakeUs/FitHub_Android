...
interface LocationRepository {
    ...
    suspend fun requestLocationData(categoryId : Int, x : String, y : String, userX : String, userY : String, keyword : String) : Result<ResponseLocationData.ResultLocationData>
