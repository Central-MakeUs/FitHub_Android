...
class ComponentBigUser(context : Context, attrs : AttributeSet) : ConstraintLayout(context, attrs) {
    ...
    private fun TypedArray.getAttributeData() {
        userProfile = this.getDrawable(R.styleable.ComponentBigUser_userProfile)!!
        userNickName = this.getString(R.styleable.ComponentBigUser_userNickName)!!
        date = this.getString(R.styleable.ComponentBigUser_time)!!
        userExercise = this.getString(R.styleable.ComponentBigUser_exercise)!!
        userLevel = this.getString(R.styleable.ComponentBigUser_level)!!
    }
}